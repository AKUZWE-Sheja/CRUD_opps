...
if(isset($_POST['submit'])){
    ...
    if($result){
        header('location:index.php?msg=A new record has been created successfully');
    }
    $conn->close();
}
?>
...
<div class="container">
    <div class="text-center mb-4">
        <h3>User's Sign-up page</h3>
        <p class="text-muted">Complete the sign-up form below</p>
    </div>
...
<div class="form-group">
      ...
      <div class="col-sm-10">
        <input type="text" class="form-control"  placeholder="Eg: Edwige" name="f_name">
      </div>
    </div>
    <div class="form-group">
      <label class="control-label col-sm-2">Last Name:</label>
      <div class="col-sm-10">
        <input type="text" class="form-control"  placeholder="Eg: SHEJA" name="l_name">
      </div>
    </div>
    <div class="form-group">
