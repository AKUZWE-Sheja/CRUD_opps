...
<!-- <a href="pdf.php" class="pdf" >PDF</a> -->
<a href="generate_pdf.php" class="pdf" >PDF</a>
...
?>
  ...
  <td>
   <a href='edit.php?id=<?php echo $users['id'] ?>' class="link-teal"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
  <a href='delete.php?id=<?php echo $users['id'] ?>' class="link-teal"><i class="fa-solid fa-trash fs-5 me-3"></i></a>
</td>
  </tr>
  <?php
}
